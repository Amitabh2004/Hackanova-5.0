  ...
  return (
    <html lang="en">
      ...
      >
        {/* --- HEADER --- */}
        <header
          className={`fixed top-0 left-0 w-full z-50 pt-4 md:pt-0 px-6 md:px-0 pointer-events-none transition-transform duration-500 ease-in-out ${showHeader ? "translate-y-0" : "-translate-y-full"}`}
        >
